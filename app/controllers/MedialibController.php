...
class MedialibController extends AdminController {
    ...
    public function getIndex()
    {
        ...
        $this->heads = array(
            array('Cover',array('search'=>true,'sort'=>true ,'attr'=>array('class'=>'span2'))),
            array('Title',array('search'=>true,'sort'=>true)),
            array('Artist',array('search'=>true,'sort'=>true)),
            array('Type',array('search'=>true,'sort'=>true, 'select'=>array(''=>'All','music'=>'Music', 'movie'=>'Movie','album'=>'Album', 'playlist'=>'Playlist' ) )),
            array('Genre',array('search'=>true,'sort'=>true)),
            array('Status',array('search'=>true,'sort'=>true, 'select'=>array(''=>'All','pending'=>'Pending', 'approved'=>'Approved' ) )),
            array('Submitted By',array('search'=>true,'sort'=>true)),
    ...
    public function postIndex()
    {
        ...
        $this->fields = array(
            array('title',array('kind'=>'text', 'callback'=>'namePic', 'query'=>'like','pos'=>'both','show'=>true)),
            ...
            array('mediatype',array('kind'=>'text','query'=>'like','pos'=>'both','show'=>true)),
            array('genre',array('kind'=>'numeric','query'=>'like','pos'=>'both','show'=>true)),
            array('status',array('kind'=>'numeric','query'=>'like','pos'=>'both','show'=>true)),
            array('ownerName',array('kind'=>'numeric','query'=>'like','pos'=>'both','show'=>true)),
        ...
        $this->additional_query = array('status'=>'approved');
