...
class TopuptrxController extends AdminController {
    ...
    public function getIndex()
    {
        ...
        $this->heads = array(
            array('Amount',array('search'=>true,'sort'=>true ,'attr'=>array('class'=>'span2'))),
            array('Type',array('search'=>true,'sort'=>true, 'select'=>array(''=>'All','voucher'=>'Voucher', 'credit'=>'Credit Card' ) )),
        ...
        $this->title = 'Top Up Transactions';
    ...
    public function postIndex()
    {
        ...
        $this->fields = array(
            ...
            array('payment',array('kind'=>'text','query'=>'like','pos'=>'both','attr'=>array('class'=>'expander'),'show'=>true)),
            array('status',array('kind'=>'text','query'=>'like','pos'=>'both','show'=>true)),
            array('userName',array('kind'=>'numeric','query'=>'like','pos'=>'both','show'=>true)),
